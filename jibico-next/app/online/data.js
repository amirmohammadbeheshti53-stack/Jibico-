...
.btn-gold{display:inline-block;background:var(--grad-gold);color:var(--navy);padding:15px 40px;border-radius:12px;font-weight:800;font-size:16px;border:none;cursor:pointer;font-family:inherit;transition:.3s;text-decoration:none}
.btn-gold:hover{transform:translateY(-4px);box-shadow:0 15px 35px rgba(242,182,50,.3)}
.hero .mini-note{display:block;margin-top:14px;color:var(--muted);font-size:13px}
.vs{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin:60px 0}
.vs-card{border-radius:18px;padding:28px;background:var(--navy2)}
...
.sec-title{text-align:center;font-size:clamp(22px,3.5vw,28px);font-weight:900;margin:0 0 12px}
...
.steps4{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:60px}
...
.why{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:60px}
.w{background:var(--navy2);border:1px solid var(--line);border-radius:16px;padding:24px 18px;text-align:center}
.w .ico{font-size:34px;margin-bottom:10px}.w h4{color:var(--gold);margin-bottom:6px}.w p{color:var(--muted);font-size:13px}
.consult-card{background:var(--navy2);border:1px solid rgba(242,182,50,.4);border-radius:24px;padding:40px;max-width:680px;margin:0 auto 20px;text-align:center}
.consult-card h2{font-size:clamp(20px,3vw,26px);font-weight:900;margin-bottom:8px}
.consult-card>p{color:var(--muted);font-size:14px;margin-bottom:25px}
.c-form{display:grid;grid-template-columns:1fr 1fr;gap:12px;text-align:right}
.c-form input,.c-form select,.c-form textarea{padding:12px 16px;border-radius:10px;border:1px solid var(--line);background:var(--navy);color:#e2e8f0;font-family:inherit;font-size:14px}
.c-form input:focus,.c-form textarea:focus{outline:none;border-color:var(--gold)}
.c-form .full{grid-column:1/-1}
.c-form button{grid-column:1/-1;background:var(--grad-gold);color:var(--navy);border:none;border-radius:12px;padding:14px;font-size:16px;font-weight:800;cursor:pointer;font-family:inherit;transition:.3s}
.c-form button:hover{transform:translateY(-3px)}
.c-note{grid-column:1/-1;color:var(--muted);font-size:12px;text-align:center}
.c-ok{display:none;padding:25px;color:#4ade80;font-weight:700;background:rgba(74,222,128,.08);border-radius:14px;font-size:15px}
.call-strip{background:var(--navy2);border:1px solid var(--line);border-radius:18px;padding:22px 26px;max-width:680px;margin:0 auto 60px;display:flex;align-items:center;gap:16px;flex-wrap:wrap}
.call-strip .cs-ico{font-size:34px}
.call-strip .cs-txt{flex:1;min-width:200px}
.call-strip .cs-txt b{display:block;font-size:15px;margin-bottom:2px}
.call-strip .cs-txt p{color:var(--muted);font-size:12px}
.call-strip .cs-btn{background:var(--grad-gold);color:var(--navy);border-radius:12px;padding:12px 26px;font-weight:900;font-size:16px;text-decoration:none;transition:.3s}
.call-strip .cs-btn:hover{transform:translateY(-3px);box-shadow:0 10px 25px rgba(242,182,50,.3)}
