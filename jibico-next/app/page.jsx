...
const ARTICLES = [
  {cls:'gold', h:'a1', e:'💰', c:'گلوگاه درآمد', t:'چرا مهارتت به درآمد تبدیل نمی‌شه؟', d:'همون سوالی که جیبیکو ازش متولد شد — با سه گلوگاه رایج و راه شروع.'},
  {cls:'blue', h:'a2', e:'🌟', c:'برندسازی', t:'برندسازی شخصی برای کارشناسان پنهان', d:'اگه مهارت داری ولی کسی نمی‌شناسه‌ات، این مقاله اولین قدم‌ها رو نشونت می‌ده.'},
  {cls:'green', h:'a3', e:'💳', c:'قیمت‌گذاری', t:'چطور برای خدمتت قیمت بگذاری؟', d:'روش سه‌بسته‌ای برای قیمت‌گذاری با اعتماد — بدون اینکه مشتری بپره.'},
]
const TESTIMONIALS = [
    ...
    <>
      ...
      <section className="lsec alt">
        ...
        <div className="wrap art-grid">
          {ARTICLES.map((a,i)=>(
            <a className="art" href={'/articles#'+a.h} key={i}>
