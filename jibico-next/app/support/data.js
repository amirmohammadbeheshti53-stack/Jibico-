...
.hero p{color:var(--muted);font-size:16px;max-width:560px;margin:0 auto 25px}
.status-chips{display:flex;gap:12px;justify-content:center;flex-wrap:wrap}
...
.schip .dot-g{display:inline-block;width:8px;height:8px;background:var(--green);border-radius:50%;margin-left:6px;animation:blink 1.5s infinite}
@keyframes blink{0%,100%{opacity:1}50%{opacity:.3}}
.sec-title{text-align:center;font-size:clamp(22px,3.5vw,30px);font-weight:900;margin:50px 0 30px}
.sec-title u{text-decoration:none;border-bottom:4px solid var(--gold);padding-bottom:6px}
.channels{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:50px}
.ch-card{background:var(--navy2);border:1px solid var(--line);border-radius:18px;padding:30px;text-align:center;transition:.3s;text-decoration:none;color:inherit;display:block}
.ch-card:hover{border-color:var(--gold);transform:translateY(-6px)}
.ch-card .ico{font-size:44px;margin-bottom:12px}
.ch-card h3{font-size:17px;margin-bottom:6px}
.ch-card p{color:var(--muted);font-size:13px}
.ch-card .val{display:inline-block;margin-top:12px;color:var(--gold);font-weight:800;font-size:15px}
.req-card{background:var(--navy2);border:1px solid rgba(242,182,50,.4);border-radius:24px;padding:40px;max-width:640px;margin:0 auto 50px;text-align:center}
.req-card h3{font-size:19px;font-weight:900;margin-bottom:8px}
.req-card>p{color:var(--muted);font-size:13px;margin-bottom:25px}
.w-form{display:grid;grid-template-columns:1fr 1fr;gap:12px;text-align:right}
.w-form input,.w-form select,.w-form textarea{padding:12px 16px;border-radius:10px;border:1px solid var(--line);background:var(--navy);color:#e2e8f0;font-family:inherit;font-size:14px}
.w-form input:focus,.w-form textarea:focus,.w-form select:focus{outline:none;border-color:var(--gold)}
...
.faq{max-width:760px;margin:0 auto 60px}
.faq-item{background:var(--navy2);border:1px solid var(--line);border-radius:14px;margin-bottom:12px;overflow:hidden}
.faq-q{width:100%;display:flex;justify-content:space-between;align-items:center;background:none;border:none;color:#e2e8f0;padding:18px 20px;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;text-align:right}
.faq-q span{color:var(--gold);font-size:20px;transition:.3s}
...
<div class="wrap">
    ...
    <div class="channels reveal">
        ...
        <a href="https://ble.ir/jibicoclub" target="_blank" class="ch-card">
            <div class="ico">📣</div>
            <h3>کانال بله جیبیکو</h3>
            <p>پیام بذار، در ساعات کاری پاسخ می‌دیم</p>
            <span class="val">ble.ir/jibicoclub</span>
        </a>
    </div>
