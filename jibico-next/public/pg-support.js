...
window.faqToggle=function(btn){btn.parentElement.classList.toggle('open');};
window.submitReq=function(ev){
    ev.preventDefault();
    var name=document.getElementById('rName').value.trim();
    var mobile=document.getElementById('rMobile').value.trim();
